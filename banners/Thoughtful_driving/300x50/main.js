...
function animate() {
  ...
  tl.to(["#txt1"], 0.5, { autoAlpha: 0, ease: Power1.easeOut }, '+=1.5');

  tl.to(["#txt2"], 0.5, { autoAlpha: 1, ease: Power1.easeOut }, '+=0.5');
  tl.to(["#txt2"], 0.5, { autoAlpha: 0, ease: Power1.easeOut }, '+=7');

  tl.to(["#logo"], 0.5, { autoAlpha: 1, ease: Power1.easeOut }, '+=1');
  tl.to(["#cta"], 0.5, { autoAlpha: 1, ease: Power1.easeOut }, '+=0.5');
}
