...
function animate() {
  ...
  tl.to("#spark", 2, { autoAlpha: 1, ease: Power1.easeInOut}, "-=10.3")
  tl.to("#spark", 1.9, {rotation:53, x:"+=80",y:"+=5", scale:5.8, ease: Power1.easeInOut}, "-=1.9")
  ...
  // tl.to(["#cta", "#cta_logo"], .7, { autoAlpha: 0}, "+=2")
