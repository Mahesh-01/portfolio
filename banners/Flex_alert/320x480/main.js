...
function animate() {
  ...
  tl1.to(['#flex-alert'], 1,{ y: '-=407', x: '-=407', ease: "power2.inOut" }, 1.4);
  tl1.to(['#flex-alert'], 0.2,{ y: '+=10', x: '+=10', ease: "power2.inOut" }, '-=0');

  tl1.to(['#txt1'], 0.5,{ x: '+=320', ease: "power2.inOut" }, '-=0.5');
  tl1.to(['#logo'], 0.5,{ x: '+=320', ease: "power2.inOut" }, '-=0.25');
  tl1.to(['#txt2a-container'], 0.5,{ width: 150, ease: "power2.inOut" }, '-=0.25');
  tl1.to(['#txt2b-container'], 0.5,{ width: 150, ease: "power2.inOut" }, '-=0.25');
  tl1.to(['#cta'], 0.5,{ x: '+=320', ease: "power2.inOut" }, '-=0.25');

  tl1.to(['#flex-alert'], 1,{ y: '+=397', x: '+=397', ease: "power2.inOut" }, '+=3');
  tl1.to(['#txt1', '#logo', '#cta'], 0.5,{ x: '-=320', ease: "power2.inOut" }, '-=1');
  tl1.to(['#txt2a-container', '#txt2b-container'], 0.5,{ x: '-=320', ease: "power2.inOut" }, '-=1');
  tl1.to(['#txt2a-container', '#txt2b-container'], 0,{ width: 0, x: '+=320', ease: "power2.inOut" }, '-=0');
  
  tl1.to(['#flex-alert'], 1,{ y: '-=407', x: '-=407', ease: "power2.inOut" }, '-=0');
  tl1.to(['#flex-alert'], 0.2,{ y: '+=10', x: '+=10', ease: "power2.inOut" }, '-=0');
